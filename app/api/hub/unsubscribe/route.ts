...
<body style="font-family: system-ui, -apple-system, sans-serif; max-width: 480px; margin: 48px auto; padding: 24px; text-align: center; background: #FAF8F5;">
  ...
  <p style="color: #888; font-size: 14px; margin-top: 24px;">You can re-enable them anytime in your <a href="${process.env.NEXTAUTH_URL || "https://www.southportguide.co.uk"}/dashboard/settings" style="color: #C9A84C;">dashboard settings</a>.</p>
</body>
</html>`,
    {
      status: 200,
